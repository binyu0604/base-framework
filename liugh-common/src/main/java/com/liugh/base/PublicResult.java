...
public class PublicResult <T> extends BaseResult<T> {
    ...
    public PublicResult(PublicResultConstant publicResultConstant, T data, Long elapsedMilliseconds) {
        super(publicResultConstant.getResult(), publicResultConstant.getMsg(), data, elapsedMilliseconds);
    }

    public PublicResult(String message, T data, Long elapsedMilliseconds) {
        super(DEFAULT_CODE, message, data, elapsedMilliseconds);
    }
